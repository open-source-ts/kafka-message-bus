...
describe('KafkaMessageBus with KafkaProvider', () => {
    ...
    describe('KafkaMessageBus with KafkaProvider - without deadletter', () => {
        beforeEach(async () => {
            consumerDefinition = {
                topic: topicName,
                handler: jest.fn()
            ...
            kafkaMessageBus.on('log', ({ message }: { level: string, message: string }) => {
                console.log(message);
            });
        ...
        it('should consume messages from kafka provider when sent to the topic', async () => {
    ...
    describe('KafkaMessageBus with KafkaProvider - with deadletter', () => {
